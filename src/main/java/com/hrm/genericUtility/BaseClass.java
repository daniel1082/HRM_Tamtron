...
import com.hrm.pomRepository.HrAssistantPage;
...
public class BaseClass {
	...
	protected HrAssistantPage hrassis;
	...
	public void launchBrowser() {
		...
		hrassis=new HrAssistantPage(driver);
	}

	@BeforeMethod
	public void loginActions() {
		//username,password,index for officer
...
//				PropertyFileKeys.PASSWORDOFFICER.convertToString());
		...
		// username,password,index for hrassistant
		String username = prop.getPropertyData(IConstantPath.PROPERTY_FILE_PATH,
				PropertyFileKeys.USERNAMEASSISTATNT.convertToString());
		String password=prop.getPropertyData(IConstantPath.PROPERTY_FILE_PATH,
				PropertyFileKeys.PASSWORDASSISTANT.convertToString());

		// username,password,index for hrhead
//		String username = prop.getPropertyData(IConstantPath.PROPERTY_FILE_PATH,
...
//				PropertyFileKeys.PASSWORD.convertToString());
		...
		webdriver.handleDropdown(ele, 3);
